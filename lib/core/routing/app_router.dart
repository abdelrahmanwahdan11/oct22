...
import '../../screens/property/property_submission_screen.dart';
...
class AppRouter {
  ...
  Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    ...
    switch (name) {
      ...
      case 'property.submit':
        return _defaultRoute(settings, const PropertySubmissionScreen());
      case 'filters.sheet':
      ...
      case 'search':
        return _defaultRoute(settings, const SearchScreen());
      case 'compare':
        return _defaultRoute(settings, const CompareScreen());
      default:
        return null;
    }
  }
