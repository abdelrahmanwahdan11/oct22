                ...
                if (vehicle != null)
                  MetricRow(
                    metrics: [
                      ...
                      MetricValue(label: strings.t('distance'), value: '${formatNumber(vehicle.miles)} ${strings.t('mi')}'),
                      MetricValue(
                        label: strings.t('weight_total'),
                        value: '${formatNumber(routeController.totalWeight)} / ${formatNumber(vehicle.capacityLb)} ${strings.t('lb')}',
                      ),
                    ],
                  ),
