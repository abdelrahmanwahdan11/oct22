...
Future<void> main() async {
  ...
  final propertiesRepository = PropertiesRepository(prefsRepository);
  await propertiesRepository.hydrateCustomProperties();
  ...
  final authController = AuthController(prefsRepository);
